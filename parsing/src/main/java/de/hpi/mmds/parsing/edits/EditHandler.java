...
class EditHandler extends DefaultHandler {

	private static final Logger LOGGER = Logger.getLogger(EditHandler.class.getName());
	private final EditWriter out;
	...
	public EditHandler(EditWriter out) {
		this.out = out;
	}
